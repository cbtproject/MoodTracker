...
package com.hussam.moodtracker.activity;
...
import com.hussam.moodtracker.Analytics;
import com.hussam.moodtracker.ArraysExtra;
import com.hussam.moodtracker.Global;
import com.hussam.moodtracker.R;
import com.hussam.moodtracker.SharedPref;
import com.hussam.moodtracker.data.DataProvider;
import com.hussam.moodtracker.data.GroupResultsDataProvider;
import com.hussam.moodtracker.data.NotesDataProvider;
import com.hussam.moodtracker.db.tables.Group;
import com.hussam.moodtracker.db.tables.Note;
import com.hussam.moodtracker.view.ColorPickerDialog;
import com.hussam.moodtracker.view.SimpleCursorDateSectionAdapter;
import com.hussam.moodtracker.view.ToggledButton;
...
//                     endTime.getMillis()))
//                     int x = (int)getValue(item,dp.getAverageValue());
//                    DatePoint date = new DatePoint(dp.time,x,"");
//                    series.add(x,date);
