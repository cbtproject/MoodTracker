...
import com.hussam.moodtracker.activity.StartupActivity;
...
public class NotificationService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
    	...
    	final NotificationManager nm = (NotificationManager)getSystemService(NOTIFICATION_SERVICE);
            final Notification note = new Notification(R.drawable.icon, " Mood Tracker", System.currentTimeMillis() + 100);
//
...
//            note.setLatestEventInfo(this, " Mood Tracker", "Don't forget to update your categories.", contentIntent);
